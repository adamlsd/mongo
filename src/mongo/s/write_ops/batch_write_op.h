...
using TargetedBatchMap = std::map<const ShardEndpoint*, std::unique_ptr<TargetedWriteBatch>, EndpointComp>;
...
public:
     ...
     */
    StatusWith<std::map<ShardId, std::unique_ptr<TargetedWriteBatch>>> targetBatch(
